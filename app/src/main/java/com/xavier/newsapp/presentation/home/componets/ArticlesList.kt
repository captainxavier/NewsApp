...
import com.xavier.newsapp.data.local.entities.toDto
import com.xavier.newsapp.domain.models.news.Article
import com.xavier.newsapp.presentation.components.ArticleCardShimmerEffect
...
fun ArticlesList(
    ...
    LazyColumn(
        ...
        items(count = articles.size) {
            ArticleCard(
                article = articles[it].toDto(),
                onClick = {
                    onClick(articles[it].toDto())
                }
            )
        }
    }
